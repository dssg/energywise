...
# train on 4 months of hourly data, test on 1 week
hrs_wk = 168
nr_mth = 4
num_train = hrs_wk * nr_mth
num_test = hrs_wk
...
parameters = {'kernel':('linear', 'rbf','poly'), 'C':[1,2,3], 
              'degree':[1,2,3], 'gamma':[0, 0.5, 1], 'shrinking':(True,False)}
svr = svm.SVR()
